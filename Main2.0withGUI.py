...
def model_things():
    ...
    for i in range(no_of_questions):
        idcaught=MainObjectGD.uploadconverted(modelimgpath+'img'+str(i+1)+'.png') #Uploading images from MODEL_ANSWER(img) as doc files
...
def student_things():
    ...
    for j in range(no_of_students):
        ...
        for i in range(no_of_questions):
            idcaught=MainObjectGD.uploadconverted(studentimgpath + str(j+1)+'/img'+str(i+1)+'.png') #Uploading images from STUDENTS_ANSWER(img) as doc files
...
########################################################## DELETING DATA AFTER COMPLETE EXCECUTION#####################################################################
...
########################################################## DELETING DATA AFTER COMPLETE EXCECUTION ENDS #####################################################################
...
def window_for_exit():
      def yes_delete_everything():                  
            ...
            # # Deleting Model Data..........................
            # for i in range(no_of_questions):
            #       os.remove(modelimgpath+'img'+str(i+1)+'.jpg')
            #       os.remove(modeltextpath+'q'+str(i+1))
            # # Deleting Model Data..........................
            ...
            #             os.remove(studenttextpath+str(i+1)+'/'+'q'+str(j+1))
            #             os.remove(studentimgpath+str(i+1)+'/'+'img'+str(j+1)+'.jpg')
            #       os.removedirs(studenttextpath+str(i+1)+'/')
            #       os.removedirs(studentimgpath+str(i+1)+'/')
            # #Deleting Students Data................
